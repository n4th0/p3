...
public class Algorithms {
	 ...
	 */
	public static <NodeLabelType, EdgeLabelType> List<Node<NodeLabelType>> dfs(Graph<NodeLabelType, EdgeLabelType> graph, Node<NodeLabelType> fromNode) {
		DFS<NodeLabelType, EdgeLabelType> dfs = new DFS<NodeLabelType, EdgeLabelType>(graph);
		dfs.run(fromNode);
	 ...
	 */
    public static <NodeLabelType, EdgeLabelType extends Comparable<EdgeLabelType>> EdgeLabelType shortestPathCost(Graph<NodeLabelType, EdgeLabelType> graph, Node<NodeLabelType> fromNode, Node<NodeLabelType> toNode, ICostOperators<EdgeLabelType> b) throws NodeNotFoundException, GraphAlgorithmException {
		DijkstraShortestPath<NodeLabelType, EdgeLabelType> dijkstraShortestPath = new DijkstraShortestPath<NodeLabelType, EdgeLabelType>(graph, b);
	 ...
	 */
	public static<NodeLabelType, EdgeLabelType> void exportDot(File file, Graph<NodeLabelType, EdgeLabelType> graph) throws FileNotFoundException {
		DotExporter<NodeLabelType, EdgeLabelType> dotExporter = new DotExporter<NodeLabelType, EdgeLabelType>();
