...
public final class Coordinate {
     ...
     * parámetro. Hace una copia defensiva del array para conservar la inmutabilidad
     * de la clase Coordinate.
     * Si este array es apunta a null se creará un objeto cuya longitud es 0, 
     * manteniendo así la inmutabilidad de la clase:
     *
    ...
    /**
     * Copy constructor.
     * Cosntructor que crea un objeto a partir de la copia defensiva
     * que proporciona el getter del atributo components. Esto se 
     * consigue creando un objeto double con la longitud del objeto creado.
     *
    ...
    /**
     * getComponents.
     * Devuelve un array de doubles idéntico a los componentes del 
     * objeto. Esto se hará de manera defensiva para manetener la 
    ...
    /**
     * getDimensions.
     * devuelve la longitud de los componentes del objeto esto siempre será
     * una copia defensiva ya que un integer es un dato primario el cual se 
     * atribuirá una nueva direccion de memoria nueva.
     *
    ...
    /**
     * hashCode.
     * Genenerador de hascode, lo genera automáticamente eclipse Source\generate hascode.
     * Devuelve un número de 32 bits ( int ) para cualquier objeto. 
     *
     ...
     * cadenas son iguales y falso si no lo son.
     * Lo genera automáticamente eclipse Source\generate equals.
     *
