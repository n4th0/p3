...
public class HTMLExporter implements IExporter {
    ...
    @Override
    public String export(BreakLine b) {
        return "<br>";
    }
    ...
    public String export(Quote quote) {
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append(createOpenTag("blockquote"));
        for (IDocumentElement iterable_element : quote.getItems()) {
            // System.out.println(iterable_element.export(this));
            stringBuilder.append(iterable_element.export(this));
        }
        stringBuilder.append(createEndTag("blockquote"));
        return stringBuilder.toString();
    }
    ...
    public String export(AbstractTextContent abstractTextContent) {
        // System.out.println(abstractTextContent.getText());
