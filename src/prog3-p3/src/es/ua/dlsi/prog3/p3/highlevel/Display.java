...
public class Display extends OutputDevice{
	...
	public byte[][] refresh() {
        ...
        while (this.getChannel().hasData()) {
            ...
            // if(0>coord[0] || coord[0]>pixel_rows || 0>coord[1] || coord[1]>pixel_rows) // no es necesario?
            //     throw new IndexOutOfBoundsException("ERROR: Display.refresh(): coordenada fuera de alcance");
