...
public class OutputDeviceTest {
	...
	public final void testReceiveFromChannel() {
		sendBytes(channel3, 2);
		assertEquals("Output device receives byte",0, out3.receiveFromChannel());
		assertEquals("Output device receives byte",1, out3.receiveFromChannel());
	}
	 ...
	 */
	@Test(expected=IllegalStateException.class)
	public final void testGetNoChannel() {
        out_nochan.get(3);
	}
	...
	public final void testGetNoProperNumBytes() {
        out3.get(4);
	}
	 ...
	 */
	@Test(expected=IllegalArgumentException.class)
	public final void testGetNoProperNumBytes2() {
        int b = -2;
        out3.get(b);
	}
