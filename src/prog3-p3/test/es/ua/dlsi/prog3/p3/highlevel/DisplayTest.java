...
public class DisplayTest {
    ...
    public final void checkBufferUnderfFlowException(){
        Display d = new Display(5);
        Keyboard k = new Keyboard();
        Channel c = new Channel(k, d);
        k.put((char)3);
        d.refresh();
    }

    @Test
    public final void notModifyTheDisplay(){
        Display d = new Display(5);
        Keyboard k = new Keyboard();
        Channel c = new Channel(k, d);
        byte [][] s = d.refresh();
        assertEquals(s, new byte[5][5]);
    }

    @Test(expected=IndexOutOfBoundsException.class)
    public final void checkIndexOutOfBounds(){
        Display d = new Display(5);
        Keyboard k = new Keyboard();
        Channel c = new Channel(k, d);
        k.put((char)-1);
    ...
    @Test(expected=IndexOutOfBoundsException.class)
    public final void checkIndexOutOfBounds2(){
        Display d = new Display(5);
        Keyboard k = new Keyboard();
        Channel c = new Channel(k, d);
        k.put((char)3);
